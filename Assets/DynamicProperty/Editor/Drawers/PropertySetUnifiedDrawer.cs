...
{
    /// Single-list UI for PropertySet.
    /// Auto-routes entries to _items32 or _items64 based on PropertyValueType (no bitness concept).
    [CustomPropertyDrawer(typeof(PropertySet))]
public class PropertySetUnifiedDrawer : PropertyDrawer
{
    ...
    private static bool Is32Type(PropertyValueType t) =>
     ...
     || t == PropertyValueType.DateTimeShort
     || t == PropertyValueType.TimeSpanShort;
